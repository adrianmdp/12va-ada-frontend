...
var getUsers = function () {
    var estoEsUnaPromesa = new Promise(function (resolve, reject) {
        setTimeout(function () {
            if (operacionExitosa) {
                // Si hay éxito
                resolve(usersDB);
...
//       console.log(asd);
//     })
var makeUsersTable = function () { return __awaiter(_this, void 0, void 0, function () {
    var otherUsers;
